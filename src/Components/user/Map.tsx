...
const locations = pharmacies.map((pharmacy) => ({
  ...
  lat: pharmacy.lat,
  lng: pharmacy.lng,
  drugs: pharmacy.drugs, // Include the drugs property
}));

// Replace with your own icon URLs if needed
const pharmacyIcon = "https://cdn-icons-png.flaticon.com/512/854/854894.png";
const userIcon = "https://cdn-icons-png.flaticon.com/512/149/149060.png";
