    ...
    >
      <div className="text-center space-y-10">
        <h1 className="md:text-5xl text-3xl mb-4 text_dark  ">
          Find your <span className="heading">medications</span> at nearby pharmacies
        </h1>
        ...
        <div className="flex gap-4 items-center justify-center">
          <button className="w-32 md:w-40 px-6  py-3 text-sm font-medium text-white bg-[#323432] rounded-xl hover:bg-[#22c3dd] transition duration-300 ease-in-out cursor-pointer">
            Register
          </button>
          <Link to={"/auth/login"} className="w-32 md:w-40 px-6  py-3 text-sm font-medium text-white bg-[#22c3dd] rounded-xl hover:bg-[#323432] transition duration-300 ease-in-out cursor-pointer">
            Login
          </Link>
        </div>
      </div>
